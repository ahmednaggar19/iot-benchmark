...
public class RateLimiterClusterSession extends RateLimiterSessionBase {
  ...
  public RateLimiterClusterSession(DBConfig dbConfig) {
    super(dbConfig);
    LOGGER = LoggerFactory.getLogger(RateLimiterClusterSession.class);
