...
public class RateLimiterSession extends RateLimiterSessionBase {
  private static class BenchmarkSession implements IBenchmarkSession {
  ...
  public RateLimiterSession(DBConfig dbConfig) {
    super(dbConfig);
    LOGGER = LoggerFactory.getLogger(RateLimiterSession.class);
  ...
  public void close() throws TsdbException {
    try {
      ...
      LOGGER.error("Will fail to shutdown service.");
